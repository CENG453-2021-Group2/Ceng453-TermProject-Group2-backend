...
public class JwtConfiguration {
    ...
    @Value("${monopoly.security.jwt.keystore-location}")
    private String keyStorePath;

    @Value("${monopoly.security.jwt.keystore-password}")
    private String keyStorePassword;

    @Value("${monopoly.security.jwt.key-alias}")
    private String keyAlias;

    @Value("${monopoly.security.jwt.private-key-passphrase}")
